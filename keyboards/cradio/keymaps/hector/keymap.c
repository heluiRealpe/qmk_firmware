...
*/
  ...
  //,--------------------------------------------.                    ,--------------------------------------------.
      _______, KC_ACL0, KC_ACL1, KC_ACL2, _______,                      KC_MPLY, KC_VOLD, KC_VOLU, KC_MUTE, _______,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      KC_ESC , QWERTY , KC_BTN2, KC_BTN1, _______,                      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_SLEP,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, _______,                      KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                          _______, _______,    _______, _______
                                      //`-----------------'  `-----------------'
  ),
